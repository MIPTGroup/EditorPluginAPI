...
### Поля структуры:
- std_version - версия стандарта, с которой плагин готов работать. Должна совпадать с той, которая содержится в PluginInterface
- reserved - зарезервированный указатель. Плагину следует игнорировать ее в текущей версии стандарта
